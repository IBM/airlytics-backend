...
public class UserCohort {
    ...
    public UserCohort(String userId, String upsId, String cohortId, String cohortValue) {
        this.userId = userId;
        this.upsId = upsId;
        this.cohortId = cohortId;
        this.cohortValue = cohortValue;
    }

    public UserCohort(String userId, String upsId, String cohortId, String cohortValue, boolean pendingDeletion, boolean pendingExport) {
        this.userId = userId;
        this.upsId = upsId;
        this.cohortId = cohortId;
        this.cohortValue = cohortValue;
