...
public class DSRCursor {
    private RetentionTrackerLogger logger = RetentionTrackerLogger.getLogger(DSRCursor.class.getName());
    private DataSerializer dataSerializer;
    private DSRCursorConfig config;

    public DSRCursor() throws IOException {
        config = new DSRCursorConfig();
