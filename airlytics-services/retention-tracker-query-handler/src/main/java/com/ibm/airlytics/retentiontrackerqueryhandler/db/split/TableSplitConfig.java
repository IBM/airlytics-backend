...
public class TableSplitConfig {
    ...
    private Map<String, TableViewConfig> athenaTableView = new HashMap<>();
    ...
    private Map<String,String> splitConfig;
    ...
    public Map<String, String> getSplitConfig() {
        return splitConfig;
    }

    public void setSplitConfig(Map<String, String> splitConfig) {
        this.splitConfig = splitConfig;
    }

    public Map<String, TableViewConfig> getAthenaTableView() {
        return athenaTableView;
    }

    public void setAthenaTableView(Map<String, TableViewConfig> athenaTableView) {
        this.athenaTableView = athenaTableView;
    }
}
