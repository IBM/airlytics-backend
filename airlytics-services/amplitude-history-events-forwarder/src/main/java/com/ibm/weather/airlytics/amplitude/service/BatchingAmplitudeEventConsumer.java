...
public class BatchingAmplitudeEventConsumer implements Consumer<AmplitudeEvent> {
    ...
    public BatchingAmplitudeEventConsumer(AmplitudeHistoryUploadService amplitudeService, AtomicInteger counter, int amplitudeBatchSize) {
