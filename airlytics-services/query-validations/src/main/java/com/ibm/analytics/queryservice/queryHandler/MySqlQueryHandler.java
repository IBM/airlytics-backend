package com.ibm.analytics.queryservice.queryHandler;
...
public class MySqlQueryHandler extends QueryHandler {
    ...
    public MySqlQueryHandler(String dbName, String dbHostPort) throws SQLException {
        if (this.conn == null){
            try {
                Class.forName("com.mysql.jdbc.Driver");
                String userName = System.getenv("MYSQL_USER");
                String password = System.getenv("MYSQL_PASSWORD");
                conn = DriverManager.getConnection("jdbc:mysql://" + dbHostPort+ "/" + dbName, userName, password);
