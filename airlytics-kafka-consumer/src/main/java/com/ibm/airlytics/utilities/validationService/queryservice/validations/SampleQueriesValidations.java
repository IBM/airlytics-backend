...
import com.ibm.airlytics.utilities.validationService.queryservice.queryHandler.MySqlQueryHandler;
...
public class SampleQueriesValidations extends BaseValidation {

    @BeforeClass
    @Parameters({"platform", "daysBefore", "testVersion", "clientType", "dbName", "tableName", "errorTableName", "minVersion", "doLoadData"})
    void setUp(String platformAndMode, int daysBefore, String testVersion, String clientType, String dbName, String tableName, String errorTableName, @Optional("minVersion") String minVersion, @Optional("doLoadData") boolean doLoadData) {
    ...
    void compareCountOnVersionTest() {
        ...
        System.out.println("compareCountOnVersionTest");
    }

    @Test
    void compareTotalTest() {
        compareCountOnVersionTest("session-end", "session-start", 1);
        System.out.println("compareTotalTest");
    }
    ...
    void eventSpecificTest() {
        ...
        System.out.println("eventSpecificTest");
    ...
    void getQueryDataTest(){
        ...
        System.out.println("getQueryDataTest");
