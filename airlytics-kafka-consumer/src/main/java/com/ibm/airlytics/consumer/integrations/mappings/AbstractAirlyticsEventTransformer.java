...
public abstract class AbstractAirlyticsEventTransformer<T> extends BasicEventTransformer {
    ...
    public AbstractAirlyticsEventTransformer(GenericEventMappingConsumerConfig config) {
        super(config);
    }
    ...
    protected void preProcessProperty(Map<String, Object> result, String key, Object value) {
    ...
    protected void convertDateTime(Map<String, Object> result, String key, Object value) {
    ...
    protected void preProcessListProperty(Map<String, Object> result, String key, Object value) {
