...
public class EventApiClient {
    private static final AirlyticsLogger LOGGER = AirlyticsLogger.getLogger(EventApiClient.class.getName());
    ...
    public void post(String json, Headers kafkaHeaders) throws IOException, EventApiException {
        ...
        if (kafkaHeaders != null) {
            ...
            for(Header header : kafkaHeaders.toArray()) {
                ...
                if(!basicHeaders.contains(header.key().toLowerCase())) {
    ...
    public void post(JsonNode json, Headers kafkaHeaders) throws IOException, EventApiException {
        post(json.toString(), kafkaHeaders);
    }
